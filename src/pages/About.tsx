...
const timeline = [
  {
    ...
    body: 'Mitthi Solutions started as a small consulting team. We kept a spreadsheet of good candidates our clients had ghosted, and it got embarrassing how long it grew.',
  },
  {
    year: '2023',
        ...
        <div className="container-page relative py-16 lg:py-22">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-lg leading-relaxed text-ink-300">
              Mitthi Solutions is us insisting otherwise.
            </p>
          </div>
        </div>
      </section>

      {/* Numbers — "50+ clients served" is the first stat */}
        ...
        <div className="grid items-center gap-10 rounded-4xl bg-white p-8 shadow-card ring-1 ring-ink-200/80 lg:grid-cols-2 lg:p-12">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button as="a" href="mailto:info@mitthisolutions.com">
                Email the team
          ...
          <dl className="grid gap-5 sm:grid-cols-2">
            {[
              ['General', 'info@mitthisolutions.com'],
              ['Employers', 'leena@mitthisolutions.com'],
              ['Candidate support', 'info@mitthisolutions.com'],
              ['Phone', '+91-9545412385'],
            ].map(([label, value]) => (
